...
var def = {
    ...
    "HTMLInputElement": {
      ...
      "prototype": {
        ...
        "select": {
          "!type": "fn()",
          "!url": "https://developer.mozilla.org/en-US/docs/Web/API/HTMLInputElement/select",
          "!doc": "Selects the input text in the element, and focuses it so the user can subsequently replace the whole entry."
        }
      }
